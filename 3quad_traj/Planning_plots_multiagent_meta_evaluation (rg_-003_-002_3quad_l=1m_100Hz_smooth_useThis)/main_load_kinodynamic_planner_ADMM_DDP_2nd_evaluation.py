...
"""--------------------------------------Load Environment---------------------------------------"""
sysm_para = np.array([0.75, 0.25, 0.15,0.15,0.2, -0.03,-0.02,0, 3, 1, 0.1, 0.75, 0.25]) 
...
pob1, pob2 = np.array([[1.6,1.15]]).T, np.array([[0.35,3.12]]).T # planar positions of the two obstacle in the world frame
...
for k in range(2):
    ...
    Coeffx[k,:] = np.load('Reference_traj_6/coeffx'+str(k+1)+'.npy')
    Coeffy[k,:] = np.load('Reference_traj_6/coeffy'+str(k+1)+'.npy')
    Coeffz[k,:] = np.load('Reference_traj_6/coeffz'+str(k+1)+'.npy')
...
for j in range(nq):
    ...
    xq_init[j*nxi:(j+1)*nxi] = ref_xc[j][0:nxi]
...
for k in range(horizon):
    if k==2 or k==int(kt*ratio) or k==int(99*ratio):
        ...
        ax7.plot([Aq[0][0,k],Aq[1][0,k]],[Aq[0][1,k],Aq[1][1,k]],color='blue',linewidth=0.5)
        ax7.plot([Aq[1][0,k],Aq[2][0,k]],[Aq[1][1,k],Aq[2][1,k]],color='blue',linewidth=0.5)
        ax7.plot([Aq[2][0,k],Aq[0][0,k]],[Aq[2][1,k],Aq[0][1,k]],color='blue',linewidth=0.5)
...
ax8.add_patch(obs1)
ax8.add_patch(obs2)
ax8.plot(Ref_pl[0,:],Ref_pl[1,:],label='Ref',linewidth=1,linestyle='--')
...
for k in range(horizon):
    if k==2 or k==int(kt*ratio) or k==int(99*ratio):
        ...
        # ax8.plot([Xq[4][0,k],Aq[4][0,k]],[Xq[4][1,k],Aq[4][1,k]],color='blue',linewidth=0.5)
        # ax8.plot([Xq[5][0,k],Aq[5][0,k]],[Xq[5][1,k],Aq[5][1,k]],color='blue',linewidth=0.5)
        ...
        # ax8.plot([Aq[3][0,k],Aq[4][0,k]],[Aq[3][1,k],Aq[4][1,k]],color='blue',linewidth=0.5)
        # ax8.plot([Aq[4][0,k],Aq[5][0,k]],[Aq[4][1,k],Aq[5][1,k]],color='blue',linewidth=0.5)
        # ax8.plot([Aq[5][0,k],Aq[0][0,k]],[Aq[5][1,k],Aq[0][1,k]],color='blue',linewidth=0.5)
        ...
        ax8.plot([Aq[0][0,k],Aq[1][0,k]],[Aq[0][1,k],Aq[1][1,k]],color='blue',linewidth=0.5)
        ax8.plot([Aq[1][0,k],Aq[2][0,k]],[Aq[1][1,k],Aq[2][1,k]],color='blue',linewidth=0.5)
        ax8.plot([Aq[2][0,k],Aq[0][0,k]],[Aq[2][1,k],Aq[0][1,k]],color='blue',linewidth=0.5)
...
ax8.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig8.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax9.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig9.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax10.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig10.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax11.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig11.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax12.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig12.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax13.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig13.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax14.plot(scPl[0,:],scPl[1,:],label='Planned_safe_copy',color='black',marker='.',markersize=1,linewidth=1)
kt= 52
ratio = (horizon/100)
for k in range(horizon):
    if k==2 or k==int(kt*ratio) or k==int(99*ratio):
...
ax14.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig14.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax15.plot(scPl[0,:],scPl[1,:],label='Planned_safe_copy',color='black',marker='.',markersize=1,linewidth=1)
kt= 53
ratio = (horizon/100)
for k in range(horizon):
    if k==2 or k==int(kt*ratio) or k==int(99*ratio):
...
ax15.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig15.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax16.plot(scPl[0,:],scPl[1,:],label='Planned_safe_copy',color='black',marker='.',markersize=1,linewidth=1)
kt= 54
ratio = (horizon/100)
for k in range(horizon):
    if k==2 or k==int(kt*ratio) or k==int(99*ratio):
...
ax16.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig16.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
ax17.plot(scPl[0,:],scPl[1,:],label='Planned_safe_copy',color='black',marker='.',markersize=1,linewidth=1)
kt= 55
ratio = (horizon/100)
for k in range(horizon):
    if k==2 or k==int(kt*ratio) or k==int(99*ratio):
...
ax17.grid(True)
# fig7.savefig('Planning_plots_multiagent_meta/system_traj_quadrotor_num6_'+str(i_train)+'_'+str(task_idx)+'.png',dpi=400)
fig17.savefig('Planning_plots_multiagent_meta_evaluation/system_traj_quadrotor_num6_'+str(kt)+'.png',dpi=400)
plt.show()
...
plt.figure(21,figsize=(6,4),dpi=300)
